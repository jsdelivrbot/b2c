...
class Footer extends CI_Controller{
	...
	public function create($status = 0){
		...
		$this->form_validation->set_rules('social_link', 'Social Link', 'required');
$this->form_validation->set_rules('column1', 'Column1', 'required');
$this->form_validation->set_rules('column2', 'Column2', 'required');
$this->form_validation->set_rules('column3', 'Column3', 'required');
